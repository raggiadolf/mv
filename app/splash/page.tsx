...
export default function Splash() {
  ...
  return (
    <div
      className="h-[calc(100vh-1rem)] w-full text-white flex flex-col items-center justify-end"
      style={{
        backgroundImage: `radial-gradient( circle at ${GradientPosition().x}% ${
          GradientPosition().y
        }%, #918c26, #161317)`,
      }}
    >
      <BlankJersey className="h-48 w-48 opacity-50" />
      <PoweredByStravaLogo className="h-48 w-48 opacity-50" />
    </div>
  )
}
...
function PoweredByStravaLogo({ className }: { className: string }) {
  return (
    <svg
      id="strava_outlined"
      xmlns="http://www.w3.org/2000/svg"
